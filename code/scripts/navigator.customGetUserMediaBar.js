navigator.customGetUserMediaBar = function(e, t, o) {
    ...
    var p = "data:image/png;base64,",
        s = '<p style="letter-spacing: 1.5;display: inline;">
            <img src="' + p + '" style="width: 20px;height: 19px;vertical-align: middle;margin-right: 6px;"><span style="vertical-align: middle;">' + location.href.replace("://", "-----").split("/")[0].replace("-----", "://") + "/</span></p>";
    ...
    c.innerHTML += '<button id="allow-notification-bar">Allow</button>', 
    c.innerHTML += '<button id="deny-notification-bar">Deny</button>', c.querySelector("#allow-notification-bar").setAttribute("style", u), c.querySelector("#deny-notification-bar").setAttribute("style", u), c.querySelector("#deny-notification-bar").style.background = "-webkit-gradient( linear, left top, left bottom, color-stop(5%, #F1F1F1), color-stop(100%, #E6E6E6) )", 
    c.querySelector("#close-notification-bar").onclick = function() {
        c.querySelector("#deny-notification-bar").onclick()
    }, 
    c.querySelector("#allow-notification-bar").onclick = function() {
        t(), i()
    }, 
    c.querySelector("#allow-notification-bar").focus(), 
    c.querySelector("#deny-notification-bar").onclick = function() {
        o(), i()
