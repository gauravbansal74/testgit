! function() {
    ...
    */
    function e(e, t) {
        ...
        function f(n) {
            return e.skipOnNewSession || (n.session || (n.session = {}), n.extra || (n.extra = {}), e.sessionid && n.sessionid != e.sessionid) ? void 0 : e.onNewSession ? (n.join = function(t) {
                ...
                e.captureUserMedia(function() {
                    e.dontCaptureUserMedia = !0,
                    e.join(n), 
                    e.dontCaptureUserMedia = s
                }, t)
        ...
        function P(t) {
            ...
            function h() {
                P.userid != t.userid && ( 
                    ...
                    getConnectionStats: function(n, t) {
                        ...
                        function i() {
                            N.prototype.getConnectionStats = window.getConnectionStats, 
                            F.connection && F.connection.getConnectionStats(n, t)
                        }
            ...
            function x() {
                if (e.isInitiator && S(ie) && S(ie) <= e.maxParticipantsAllowed && (e.session.oneway || e.session.broadcast || oe.send({
                    ...
                    for (var n in e.renegotiatedSessions) 
                        t.renegotiatedOnce = !0, 
                        e.renegotiatedSessions[n] && e.renegotiatedSessions[n].stream && e.peers[t.userid].renegotiate(e.renegotiatedSessions[n].stream, e.renegotiatedSessions[n].session)
            }
            ...
            function E(i) {
                if (!re && i.userid != e.userid) {
                    if (i.sdp) {
                        t.userid = i.userid, 
                        t.extra = i.extra || {}, 
                        t.renegotiate = i.renegotiate, 
                        t.streaminfo = i.streaminfo, 
                        t.isInitiator = i.isInitiator, 
            ...
            var F, _ = t.isofferer,
                j = {
                    ...
                    oniceconnectionstatechange: function(n) {
                        p("oniceconnectionstatechange", g(n)), 
                        F.connection && "connected" == F.connection.iceConnectionState && "complete" == F.connection.iceGatheringState && "stable" == F.connection.signalingState && 1 == e.numberOfConnectedUsers && e.onconnected({
                            userid: t.userid,
                            extra: t.extra,
            ...
            return e.openSignalingChannel({
                onmessage: function(n) {
                    if (!re && n.userid != e.userid) {
                        if (n.sessionid && n.userid && 
                                (e.sessionDescriptions[n.sessionid] || 
                                    (e.numberOfSessions++, e.sessionDescriptions[n.sessionid] = n, e.isAcceptNewSession && (e.dontOverrideSession || (e.session = n.session), f(n)))), 
                                n.newParticipant && !e.isAcceptNewSession && te.broadcasterid === n.userid && n.newParticipant != e.userid && F(n), 
                                S(ie) < e.maxParticipantsAllowed && n.targetUser == e.userid && n.participant) {
                        ...
                        n.shareWith == e.userid && n.dontShareWith != e.userid && n.joinUsers && B(n.joinUsers), 
                        !n.shareWith && n.joinUsers && (n.dontShareWith ? e.userid != n.dontShareWith && B(n.joinUsers) : B(n.joinUsers)), 
                        n.messageFor == e.userid && n.presenceState && ("checking" == n.presenceState && (oe.send({
                                messageFor: n.userid,
                            ...
                            J(n._config))), 
                        n.donotJoin && n.messageFor == e.userid && p(n.userid, "is not joining your room."), 
                        n.isDisconnectSockets && (p("Disconnecting your sockets because initiator also disconnected his sockets."), e.disconnect())
                    }
                },
                callback: function(e) {
                    e && this.onopen(e)
                ...
                onopen: function(n) {
                    ...
                    j && j(), 
                    te.defaultSocket = oe, 
                    oe.__push || (oe.__push = oe.send, oe.send = function(n) {
        ...
        A("beforeunload", te.leaveHandler), 
        A("keyup", te.leaveHandler), te.onLineOffLineHandler = function() {
            navigator.onLine ? te.isOffLine && (te.isOffLine = !navigator.onLine) : te.isOffLine = !0
        }, 
        A("load", te.onLineOffLineHandler), 
        A("online", te.onLineOffLineHandler), 
        A("offline", te.onLineOffLineHandler);
        ...
        this.addStream = function(n) {
            function t(t) {
                ...
                var o = t.peer;
                return n.stream && (o.attachStreams = [n.stream]), 
                U(e.detachStreams, o.connection), 
                n.stream && (i.audio || i.video || i.screen) && (G || z && !o.connection.getLocalStreams().length) && o.addStream(n.stream), z || "firefox" == t.userinfo.browser ? t.redial() : void o.recreateOffer(i, function(n, t) {
                    L({
                        sdp: n,
                        socket: s,
                        renegotiate: i,
        ...
        this.disconnect = function() {
            ...
            e.refresh(), 
            te.defaultSocket = oe = null, re = !0, e.ondisconnected({
                userid: e.userid,
                extra: e.extra,
            ...
            e.close(), 
            window.removeEventListener("beforeunload", te.leaveHandler), 
            window.removeEventListener("keyup", te.leaveHandler), 
            delete this, 
            p("Disconnected your sockets, peers, streams and everything except RTCMultiConnection object.")
        }
    }


    /*
    Function taking care of create ,  getLocalDescription
    serializeSdp ,     init ,     setBandwidth ,     setConstraints
    onSdpError ,     onSdpSuccess ,     onMediaError ,     setRemoteDescription
    addIceCandidate,     createDataChannel ,     setChannelEvents ,    addStream
    attachMediaStreams ,     getStreamInfo ,     recreateOffer ,     recreateAnswer
    */
    function n() {
        return {
            create: function(e, n) {
            ...
            init: function() {
                ...
                this.connection.onaddstream = function(e) {
                    p("onaddstream", Q ? e.stream : g(e.stream)), 
                    n.onaddstream(e.stream, n.session)
                }, 
                ...
                e.onopen = function() {
                    e.push = e.send, e.send = function(i) {
                        if ("disconnected" != n.connection.iceConnectionState && -1 == e.readyState.search(/closing|closed/g) && -1 != e.readyState.search(/connecting|open/g)) {
                            ...
                            if ("connecting" == e.readyState) return t++, 
                                setTimeout(function() {
            ...
            addStream: function(e) {
                console.log(" RTCmulticonnection - addStream",e );

                e.streamid || Y || (e.streamid = o()), 

                p("attaching stream:", e.streamid, Q ? e : g(e)), 

                this.connection.addStream(e), 
            ...
            attachMediaStreams: function() {
                for (var e = this.attachStreams, n = 0; n < e.length; n++) 
                    this.addStream(e[n])
            },
    ...
    function w(e, n) {
        ...
        return t[z ? "mozSrcObject" : "src"] = z ? e : 
            window.URL.createObjectURL(e), 
            t.controls = !1, 
            t.autoplay = !!n.remote, 
            t.muted = n.remote ? !1 : !0, 
            z && t.addEventListener("ended", function() {
                                                        e.onended()
                                                    }, !1), t.play(), t
    }
    ...
    function T(e, n) {
        ...
        if (!window.FileBufferReader) return void M(e.resources.FileBufferReader, function() {
            T(e, n)
        });
    ...
    function E(e) {
        if (le.screen.extensionid == ce && !ie) {
            ...
            n.onload = function() {
                n.isLoaded = !0, 
                p("Screen Capturing frame is loaded.")
            }, 

            n.src = "sharescreen.html", 
    ...
    /*
    geticeserver.html added to indexpage 
    */
    function D(e, n) {
        /*
        if (!se) {
    ...
    /*
    hark - speaking , not speaking , columen change 
    */
    function I(e) {
    ...
    function P(e) {
        ...
        e.autoTranslateText = !1, 

        e.googKey = "AIzaSyCgB5hmFY74WYB-EoWkhr9cAGr6TiTHrEE", 
        ...
        e.resources = {
            ...
            muted: "https://miljul.in/images/muted.png?" + Math.random(),
        ...
        e.onFileStart = function(n) {
            ...
            i.title = n.name, 
            i.innerHTML = "<label>0%</label> <progress></progress>", 

            document.querySelector(".popup-messages").appendChild(document.createElement("br")),
            document.querySelector(".popup-messages").appendChild(i), 
            t[n.uuid] = {
                div: i,
                progress: i.querySelector("progress"),
                label: i.querySelector("label")
            }, 
            t[n.uuid].progress.max = n.maxChunks

        }, 

        e.onFileProgress = function(e) {
            var i = t[e.uuid];
            i && (i.progress.value = e.currentPosition || e.maxChunks || i.progress.max, n(i.progress, i.label))
        }, 
        ...
        e.onmute = function(n) {
            n.isVideo && n.mediaElement && 
            (
                n.mediaElement.pause(), 
                n.mediaElement.setAttribute("poster", e.resources.muted), 
                n.mediaElement.style.display = "none"
            ), 
            n.isAudio && n.mediaElement && (n.mediaElement.muted = !0)
        }, 

        e.onunmute = function(e) {
            e.isVideo && e.mediaElement && 
            ( 
                e.mediaElement.play(), 
                e.mediaElement.removeAttribute("poster"), 
                e.mediaElement.style.display = "initial", 
                e.mediaElement.volume = .5
            ), 
            e.isAudio && e.mediaElement && (e.mediaElement.muted = !1, e.mediaElement.volume = .5)
        }, 
        ...
        e._skip = ["stop", "mute", "unmute", "_private", "_selectStreams", "selectFirst", "selectAll", "remove"], 
        ...
        */
        ...
        i.push({"username":"1_0eabc30e-52bd-11e5-8587-3ca0177e5db5",
                "url":"turn:turn02.uswest.xirsys.com:443?transport=udp",
                "credential":"0eabc3cc-52bd-11e5-9fe8-680b2c158d26"}), 
        i.push({"credential": "0eabc3cc-52bd-11e5-9fe8-680b2c158d26",     
                "url": "turn:turn02.uswest.xirsys.com:443?transport=tcp",
                "username": "1_0eabc30e-52bd-11e5-8587-3ca0177e5db5"});
        i.push({"credential": "0eabc3cc-52bd-11e5-9fe8-680b2c158d26",
        ...
        e.onMediaFile = function(n) {
            p("onMediaFile", n), 
            e.body.appendChild(n.mediaElement)
        }, 
        ...
        !Q && le.screen.onScreenCapturingExtensionAvailable && (
                le.screen.onScreenCapturingExtensionAvailable = function() {
        ...
        e.onconnected = function(e) {
            p("Connection has been established between you and", e.userid);
        }, 
        ...
        e.openSignalingChannel = function(n) {
            ...
            e.socket || (e.socket = i), 
            i.onDisconnect().remove(), setTimeout(function() {
                n.callback(i)
            }, 1)
        }, 
    ...
    var U = location.href,
        L = U.split("?");
    window.RMCDefaultChannel = L[0].replace(/\/|:|#|%|\.|\[|\]/g, "") + currentTimeTicker, 
    window.RTCMultiConnection = function(n) {
        function i(n) {
        ...
        function m(e, n, i) {
            ...
            function s(t) {
                if (t.data && t.data.chromeMediaSourceId) {
                    ...
                    if (le.screen.sourceId = i, 
                        le.screen.chromeMediaSource = "desktop", 
                        "PermissionDeniedError" == i) {
                        ...
                        return V.mutex = !1, 
                        le.screen.sourceId = null, 
                        b.onMediaError(o)
                    }
                    m(e, n)
                }

                t.data && t.data.chromeExtensionStatus && (
                                            v("Screen capturing extension status is:", t.data.chromeExtensionStatus), 
                                            le.screen.chromeMediaSource = "screen", 
                                            m(e, n, !0))
            }
            ...
            function o(n, i, s, r) {
                if (b.onstatechange({
                    ...
                    }), b.preventSSLAutoAllowed && !r && G) 
                    
                    return navigator.customGetUserMediaBar ? 
                        void navigator.customGetUserMediaBar(n, 
                            function() {
                                o(n, i, s, !0)
                            }, 
                            function() {
                        ...
                        : void M(b.resources.customGetUserMediaBar, 
                            function() {
                                o(n, i, s, r)
                            });
                ...
                var c = {
                    ...
                    onerror: function(n, t) {
                        if (z && "PERMISSION_DENIED" == n && (n = {
                                ...
                                constraintName: t,
                                session: a
                            }), z && t.video && t.video.mozMediaSource) 
                            return i = {
                                message: ae,
                        ...
                        a.screen && (z ? h(ae) : "https:" !== location.protocol ? 
                            X || "file:" != location.protocol && 
                            "http:" != location.protocol || h("Cannot use HTTP or file protocol for screen capturing. Use HTTPs or chrome extension or Node-Webkit page.") 
                            : h('Maybe "deprecated"Permissions issue . Please install chrome-extension: https://chrome.google.com/webstore/detail/screenshare/pmcehcchogemjkgofbnlhfdlgoedkpoa')), V.mutex = !1;
            ...
            if (a.screen) {
                ...
                if (G && le.screen.extensionid != ce && (ue = !0),G && !ue && !i && !le.screen.sourceId) 
                    return A("message", s), 
                te || E(), 
                void te.postMessage();
                ...
                if (G && ue && !i && "screen" == le.screen.chromeMediaSource && le.screen.extensionid) return le.screen.extensionid == ce ? m(e, n, !0) : (p("checking if chrome extension is installed."), void le.screen.getChromeExtensionStatus(function(t) {
                    "installed-enabled" == t && (le.screen.chromeMediaSource = "desktop"), 
                    m(e, n, !0), 
                    p("chrome extension is installed?", "desktop" == le.screen.chromeMediaSource)
                }));
        ...
        function f(e, n, t, i, r, a, d, c, u, m) {
            ...
            d && (e = s(e)), 
            b.localStreamids.push(i), 
            e.onended = function() {
                p.mediaElement && !p.mediaElement.parentNode && document.getElementById(e.streamid) && (p.mediaElement = document.getElementById(e.streamid)), 
                b.attachStreams.forEach(function(n, t) {
                ...
                V.mutex = !1, 
                V.streams[t] && delete V.streams[t], 
                le.screen.sourceId = null
            }, 
        ...
        var S, 
        b = this;
        b.channel = n || RMCDefaultChannel, 
        b.isAcceptNewSession = !0, 
        b.open = function(e) {
            b.isAcceptNewSession = !1, 
            b.isInitiator = !0;
            var n = !1;
            return e && (d(e) ? b.sessionid = e : (
                            a(e.transmitRoomOnce) || (b.transmitRoomOnce = e.transmitRoomOnce), 
                            a(e.dontTransmit) || (n = e.dontTransmit), 
                            a(e.sessionid) || (b.sessionid = e.sessionid))), 
                            b.socket && b.socket.remove && b.socket.remove(), 
                            b.sessionid || (b.sessionid = b.channel), 
            ...
            b.sessionDescriptions[b.sessionDescription.sessionid] || (b.numberOfSessions++, b.sessionDescriptions[b.sessionDescription.sessionid] = b.sessionDescription), 
            i(function() {
                S.captureUserMediaOnDemand = e ? !!e.captureUserMediaOnDemand : !1, 
                    e && e.onMediaCaptured && (b.onMediaCaptured = e.onMediaCaptured), 
                    S.captureUserMediaOnDemand || m(function() {
                        S.initSession({
        ...
        var C = !0;
        b.captureUserMedia = m, b.leave = function(e) {
    ...
    var te, ie, se, oe = {},
        re = {},
        ae = 'Firefox Nightly enable-> media.getusermedia.screensharing.enabled flag from about:config page. You also need to add your domain in "media.getusermedia.screensharing.allowed_domains" flag. If you are using WinXP then also enable "media.getusermedia.screensharing.allow_on_old_platforms" flag. NEVER forget to use "only" HTTPs for screen capturing!',
        de = "HTTPs i.e. SSL-based URI is mandatory to use screen capturing.",
        ce = "pmcehcchogemjkgofbnlhfdlgoedkpoa",
    ...
    ! function() {
        ...
        le.isAudioContextSupported = !(!window.AudioContext && !window.webkitAudioContext || !AudioContext.prototype.createMediaStreamSource), 
        le.isScreenCapturingSupported = G && Z >= 26 && (X ? !0 : "https:" == location.protocol), 
        le.isSctpDataChannelsSupported = !!navigator.mozGetUserMedia || G && Z >= 25, 
        le.isRtpDataChannelsSupported = G && Z >= 31, e(), 
        le.load = e;
        ...
        le.screen = {
            ...
            getSourceId: function(e) {
                console.log("rtcmulticonn- getSourceId ",e);
                function t(t) {
            ...
            onMessageCallback: function(e) {
                ...
                console.log("rtcmulticonn- onMessageCallback ==> ",e);

                if (d(e) || e.sourceId) {
                    console.log(" RTCmulticonnection - section of e.sourceId");
                    if ( p("chrome message", e), "PermissionDeniedError" == e) {
                        if (le.screen.chromeMediaSource = "PermissionDeniedError", n) 
                            return n("PermissionDeniedError");
                        throw new Error("PermissionDeniedError")
                    }

                    "miljul-extension-loaded" == e && 
                        (le.screen.chromeMediaSource = "desktop",
                         le.screen.onScreenCapturingExtensionAvailable && 
                            (le.screen.onScreenCapturingExtensionAvailable(), 
                             le.screen.onScreenCapturingExtensionAvailable = null)), 
                    
                    e.sourceId && (le.screen.sourceId = e.sourceId,n && n(le.screen.sourceId))
                

                }
                
                if(e.chromeMediaSourceId){
                    console.log("RTCmulticonnection - Not in section of e.sourceId");
                    var s = {
                        screen: !0
                    };

                    var t= e.chromeMediaSourceId;
                    rtcMultiConnection.captureUserMedia(function(t) {

                        var n = rtcMultiConnection.token();
                        
                        rtcMultiConnection.customStreams[n] = t;
            ...
            getChromeExtensionStatus: function(e, n) {
                console.log("rtcmulticonn- check chromeExtensionStatus ==>",e);
                function t(e) {
                    le.screen.status = e, 
                    n(e)
                }
                ...
                i.onload = function() {
                    ...
                    setTimeout(function() {
                        t("screen" == le.screen.chromeMediaSource ? 
                            "desktop" == le.screen.chromeMediaSource ? "installed-enabled" : "installed-disabled" : "installed-enabled")
                    }, 2e3)
                }, 
                i.onerror = function() {
                    t("not-installed")
    ...
    c(fe) || window.onPluginRTCInitialized(fe), Q && M("Plugin.EveryWhere.js")
}();



// ------------------------- screensharing continied ---------------------- 
...
DetectRTC.screen = {
    ...
    getSourceId: function (callback) {
        ...
        console.log("uimain- getSourceId ");
    ...
    onMessageCallback: function (data) {
        ...
        if (data == 'miljul-extension-loaded') {
    ...
    getChromeExtensionStatus: function (callback) {
        console.log("uimain- check chromeExtensionStatus ");
        var extensionid = 'pmcehcchogemjkgofbnlhfdlgoedkpoa';
        ...
        image.onload = function () {
            ...
            setTimeout(function () {
                ...
                console.log("DetectRTC.screen.chromeMediaSource", DetectRTC.screen.chromeMediaSource);
...
//load icons for screensharing 
DetectRTC.screen.getChromeExtensionStatus(function (status) {
    console.log(" DetectRTC.screen.getChromeExtensionStatus"+ status);
    if (status == 'not-installed' ) {
        document.getElementById('extension_installed').style.display = 'none';
        document.getElementById('install-extension').style.display = 'block'; 
    }
    /*
    else if( status == 'installed-disabled'){
        alert("To make screen-sharing work please enable the screensharing extension from chrome settings");
    } */
    else{
        document.getElementById('extension_installed').style.display = 'block';
        document.getElementById('install-extension').style.display = 'none';
    }
});
...
function captureSourceId() {
    ...
    var sharingscreensourceID;
    
    DetectRTC.screen.getChromeExtensionStatus(function (status) {

        if (status != 'installed-enabled') {
            alert(" The Chrome Extension for screen sharing is either not installed or enabled ");
                    ...
                    !!chrome.webstore && 
                        !!chrome.webstore.install && 
                            chrome.webstore.install('https://chrome.google.com/webstore/detail/pmcehcchogemjkgofbnlhfdlgoedkpoa', 
                                    function() { 
                                       // location.reload(); 
                                        alert("Installation completed ! Refreshing page ");
        ...
        DetectRTC.screen.getSourceId( function (sourceId) {
            console.log("uimain post message to parent sourceId ==> ", sourceId);
            sharingscreensourceID = sourceId;
    ...
    return sharingscreensourceID;
}


function addsharescreen(t){
        ...
        rtcMultiConnection.captureUserMedia(function(t) {
            ...
            console.log("uimain rtcMultiConnection.captureUserMedia", t);
